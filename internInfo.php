...
if (!empty($_GET['rowid'])) {
    $rowid = $_GET['rowid'];
    $fetch = "SELECT * FROM studentinfo INNER JOIN time_record ON studentinfo.studid = time_record.studid;";
    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="intern-info">
                <div class="profile">
                    <img src="img/ab6761610000e5eba07eb018071ca45120dceb4f.jpg" alt="Profile Picture">
